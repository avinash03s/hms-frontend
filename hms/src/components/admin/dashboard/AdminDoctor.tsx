...
import { deleteDoctor, getAllDoctors } from "../../../service/AdminService";
    ...
    <Box p="xl" style={{ minHeight: "100vh", background: "#f8fafb" }}>
                ...
                <Box p="lg">
                  ...
                  <Group gap="md" mb="md" align="flex-start">
                    ...
                    <Stack gap={2} style={{ flex: 1 }}>
                      <Text fw={700} size="md" style={{ color: "#1a1a2e", lineHeight: 1.2 }} lineClamp={1}>
                        {doctor.name}
                      </Text>
                      <Badge
                        size="sm"
                  ...
                  <Stack gap={10}>
                    ...
                    {doctor.phone && (
                      <Group gap="xs" align="center">
                        ...
                        <Text size="xs" c="dimmed">{doctor.phone}</Text>
                      </Group>
                    )}
                    ...
                    {doctor.department && (
                      <Group gap="xs" align="center">
                        <Box style={{ flexShrink: 0 }}>
                          <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
                            <path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2V9z" stroke="#20c997" strokeWidth="1.8" />
                            <path d="M9 22V12h6v10" stroke="#20c997" strokeWidth="1.8" />
                          </svg>
                        </Box>
                        <Text size="xs" c="dimmed" lineClamp={1}>{doctor.department}</Text>
                      </Group>
                    )}
                    ...
                    {doctor.experience && (
                      <Group gap="xs" align="center">
                        <Box style={{ flexShrink: 0 }}>
                          <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
                            <circle cx="12" cy="12" r="9" stroke="#20c997" strokeWidth="1.8" />
                            <path d="M12 7v5l3 3" stroke="#20c997" strokeWidth="1.8" strokeLinecap="round" />
                          </svg>
                        </Box>
                        <Text size="xs" c="dimmed">{doctor.experience} yrs experience</Text>
                      </Group>
                    )}
                    ...
                    {doctor.gender && (
                      <Group gap="xs" align="center">
                        ...
                        <Text size="xs" c="dimmed" style={{ textTransform: "capitalize" }}>{doctor.gender}</Text>
                      </Group>
                    )}
                  </Stack>
      ...
      >
        ...
        <Group justify="flex-end" gap="sm">
          <Button variant="light" radius="xl" onClick={() => setDeleteModalOpen(false)}>
            Cancel
          </Button>
