...
// import { Button, TextInput, Select, Skeleton, Badge } from "@mantine/core";
// import {
...
//             style={{ background: `linear-gradient(135deg, ${color.bg}, white)` }}
//           >
...
//   // Filter — only depends on search/category/gender, NOT packages state
//   useEffect(() => {
...
//     if (selectedGender) {
//       result = result.filter(
//         (p) => p.idealFor === selectedGender || p.idealFor === "Both"
//       );
//     }
//     setFiltered(result);
...
//             {hasFilters && (
//               <button onClick={clearFilters}
//                 className="text-sm text-[#1a6fa8] font-semibold hover:underline">
//                 Clear all filters
//               </button>
//             )}
//           </div>
