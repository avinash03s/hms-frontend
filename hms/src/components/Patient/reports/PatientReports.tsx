...
const downloadPDF = (p: PrescriptionDTO, patientName: string) => {
  ...
  <style>
    *{margin:0;padding:0;box-sizing:border-box}
    ...
    .header{display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:32px;padding-bottom:20px;border-bottom:2px solid #1a6fa8}
    .logo{font-size:24px;font-weight:700;color:#1a6fa8}.logo span{color:#111827}
    .rx{background:#e6f0f7;color:#15568a;font-size:28px;font-weight:700;padding:4px 16px;border-radius:8px;display:inline-block;margin-bottom:6px}
        ...
        >
            <div style={{ padding: "18px 22px 14px", borderBottom: "1px solid #f0f0f0", display: "flex", justifyContent: "space-between", alignItems: "center", position: "sticky", top: 0, background: "#fff", zIndex: 1, borderRadius: "16px 16px 0 0" }}>
                <div>
                    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                        <span style={{ background: p.archived ? "#FEF3C7" : "#e6f0f7", color: p.archived ? "#92400E" : "#15568a", fontSize: 13, fontWeight: 600, padding: "3px 10px", borderRadius: 6 }}>
                            ℞ Prescription #{p.id}
                        </span>
                        {p.archived && (
                ...
                <div style={{ display: "flex", gap: 8 }}>
                    <button
                        ...
                        style={{ background: "#1a6fa8", color: "#fff", border: "none", borderRadius: 8, padding: "8px 14px", fontSize: 13, fontWeight: 500, cursor: "pointer" }}
                    >
                        ⬇ Download PDF
                    </button>
                    <button
            ...
            <div style={{ padding: "18px 22px" }}>
                ...
                <div style={{ borderRadius: 8, overflow: "hidden", border: "1px solid #e5e7eb" }}>
                    <div style={{ display: "grid", gridTemplateColumns: "2fr 0.8fr 1.3fr 0.7fr", padding: "8px 12px", background: "#1a6fa8", fontSize: 11, color: "#fff", fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.04em", gap: 8 }}>
                ...
                <button
                    onClick={() => downloadPDF(p, patientName)}
                    style={{ marginTop: 18, width: "100%", background: "#1a6fa8", color: "#fff", border: "none", borderRadius: 10, padding: "12px", fontSize: 14, fontWeight: 500, cursor: "pointer" }}
                >
                    ⬇ Download PDF
                </button>
            </div>
                ...
                >
                    ...
                    <div className="mb-6">
                        <h1 className="text-2xl font-extrabold text-gray-900 flex items-center gap-2.5">
                            <span style={{ width: 36, height: 36, background: "#e6f0f7", borderRadius: 8, display: "inline-flex", alignItems: "center", justifyContent: "center" }}>
                                <IconReceipt size={20} color="#15568a" />
                            </span>
                            My Prescriptions
                        </h1>
                                ...
                                <div style={{ display: "flex", alignItems: "center", gap: 4, background: "#f9fafb", borderRadius: 8, padding: "4px 6px", border: "1px solid #f0f0f0" }}>
                                    ...
                                    {(["all", "1m"] as DateFilter[]).map((f) => (
                                        <button
                                            ...
                                            style={{
                                                background: dateFilter === f ? "#1a6fa8" : "transparent",
                                        ...
                                        >
                                            {f === "all" ? "Current Month" : "Previous Month"}
                                        </button>
                                    ))}
                                </div>
                    ...
                    {loading && (
                        <div style={{ display: "flex", alignItems: "center", gap: 10, color: "#6b7280", fontSize: 14 }}>
                            <span style={{ width: 18, height: 18, border: "2px solid #1a6fa8", borderTopColor: "transparent", borderRadius: "50%", display: "inline-block", animation: "spin 0.7s linear infinite" }} />
                        ...
                        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                            {filtered.map((r) => (
                                <div
                                    ...
                                    onMouseEnter={(e) => {
                                        (e.currentTarget as HTMLDivElement).style.borderColor = r.archived ? "#F59E0B" : "#1a6fa8";
                                    ...
                                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                                        <div style={{ flex: 1 }}>
                                            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 8 }}>
                                                <span style={{ width: 36, height: 36, borderRadius: 8, background: r.archived ? "#FEF3C7" : "#e6f0f7", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 16, fontWeight: 700, color: r.archived ? "#92400E" : "#15568a", flexShrink: 0 }}>
                                                    ℞
                                                </span>
                                                <div>
                                                    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                                        ...
                                        <div style={{ textAlign: "right", flexShrink: 0, marginLeft: 14 }}>
                                            <span style={{ background: r.archived ? "#FEF3C7" : "#e6f0f7", color: r.archived ? "#92400E" : "#15568a", fontSize: 12, padding: "3px 10px", borderRadius: 6, fontWeight: 500, display: "block", marginBottom: 4 }}>
                                            ...
                                            <button
                                                ...
                                                style={{ marginTop: 6, background: "transparent", border: "1px solid #1a6fa8", color: "#1a6fa8", borderRadius: 6, padding: "4px 10px", fontSize: 11, cursor: "pointer", fontWeight: 500 }}
                                            >
                                                ⬇ PDF
                                            </button>
                                        </div>
