...
const downloadPDF = (p: PrescriptionDTO, patientName: string) => {
  ...
  <div class="info-grid">
    ...
    <div class="info-box">
      ...
      <div class="info-value">Dr. ${p.doctorName}</div>
    </div>
    <div class="info-box">
  ...
  <div class="footer">
    ...
    <div class="sign-box">
      <div class="sign-name">Dr. ${p.doctorName}</div>
        ...
        <div style={{ padding: 24, fontFamily: "'Segoe UI', sans-serif" }}>
            ...
            <div style={{ marginBottom: 22 }}>
                <h2 style={{ fontSize: 22, fontWeight: 600, color: "#111827", margin: 0, display: "flex", alignItems: "center", gap: 10 }}>
                    <span style={{ width: 36, height: 36, background: "#E1F5EE", borderRadius: 8, display: "inline-flex", alignItems: "center", justifyContent: "center", fontSize: 18 }}><IconReport/></span>
                    My Prescriptions
                </h2>
            ...
            {!loading && !error && (
                <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 12, marginBottom: 18 }}>
                    {[
                        ...
                        ["Total Medicines", reports.reduce((acc, r) => acc + (r.medicines?.length ?? 0), 0)],
                    ].map(([label, value]) => (
            ...
            {!loading && !error && reports.length > 0 && (
                <input
                    type="text"
                    placeholder="🔍  Search by medicine name or notes..."
                    value={search}
            ...
            {!loading && !error && filtered.length === 0 && (
                <div style={{ textAlign: "center", padding: "48px 16px", color: "#9ca3af", fontSize: 14 }}>
                    {search ? "No prescriptions found for this search." : "No prescriptions found yet."}
                </div>
            )}
                            ...
                            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                                <div style={{ flex: 1 }}>
                                    <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 8 }}>
                                        {/* Rx Badge */}
                                        <span style={{ width: 36, height: 36, borderRadius: 8, background: "#E1F5EE", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 16, fontWeight: 700, color: "#0F6E56", flexShrink: 0 }}>
                                            ℞
                                        </span>
                                        <div>
                                            ...
                                            <p style={{ fontSize: 12, color: "#9ca3af", margin: 0 }}>
                                                Doctor #{r.doctorId} · Appointment #{r.appointmentId}
                                            </p>
                                        </div>
                                    </div>
