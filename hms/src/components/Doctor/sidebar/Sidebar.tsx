import { IconHeartbeat, IconLayoutGrid, IconCalendarCheck,  IconUser, IconVaccine } from "@tabler/icons-react";
...
const links = [
    ...
    {
        name: "Reports", url: "/doctor/pharmacy", icons: <IconVaccine stroke={1.5} />
    },
]
